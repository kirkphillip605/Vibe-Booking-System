          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white shadow rounded p-4">
              ...
              <ul className="flex flex-col space-y-2">
                <li>
                  <Link to="/bookings" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center">
                    <Plus className="mr-2" size={16} /> Create Booking
                  </Link>
                </li>
                <li>
                  <Link to="/clients" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded flex items-center">
                    <Users className="mr-2" size={16} /> Add Client
                  </Link>
                </li>
                <li>
                  <Link to="/venues" className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded flex items-center">
